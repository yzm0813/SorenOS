...
const port='18787';
const child=spawn(process.execPath,[resolve('apps/core/node_modules/tsx/dist/cli.mjs'),resolve('apps/core/src/server.ts')],{env:{...process.env,SOREN_DATA_ROOT:dataRoot,SOREN_PORT:port},stdio:['ignore','pipe','pipe']});
