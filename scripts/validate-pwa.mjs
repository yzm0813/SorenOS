...
assert.match(sw,/push_received/);assert.match(sw,/notification_displayed/);assert.match(sw,/notification_display_failed/);assert.match(sw,/showNotification\('Soren'/);
