...
export class MomentsService {
  ...
  constructor(store:SorenDatabase,private readonly onCreated?:(post:MomentPost)=>void){this.social=new SocialStore(store);this.social.ensureActors(socialActors);this.social.reconcileRecentUserPosts();this.social.reconcileRecentUserReplies();}
